...
import { Category, Game, Guest, TailgateItem } from '@/lib/types';
...
export default function TailgateSection({ game, guests, items, onChange }: Props) {
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="bg-[var(--ink)] text-white border-none py-2.5 px-3 rounded-[10px] w-full cursor-pointer text-[13px] font-bold flex items-center justify-center gap-2 mt-3 hover:bg-[#2a2a2a]"
        >
          <span className="text-[14px]">📤</span> Share menu with the crew
        </button>
      </Section>
